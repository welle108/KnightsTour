...
public class KnightsTour {
    ...
    private static void bruteBacktrack(ArrayList<Position> tour, int[][]visited){
        ...
        if(tour.size() == full){
            ...
            ArrayList<Position> moves = checkMoves(tour, visited);
    ...
    private static ArrayList<Position> checkMoves(ArrayList<Position> tour, int[][] visited){
        ...
        }else if(x-2 >= 0 && y-1 >= 0 && visited[x-2][y-1] != 1){
            possible_moves.add(new Position(x-2,y-1));
        }
        else if(x-1 >= 0 && y+2 < dimen && visited[x-1][y+2] != 1){
            possible_moves.add(new Position(x-1,y+2));
        }
        else if(x-1 >= 0 && y-2 >= 0 && visited[x-1][y-2] != 1){
            possible_moves.add(new Position(x-1,y-2));
        }
        else if(x+1 < dimen && y-2 >= 0 && visited[x+1][y-2] != 1){
            possible_moves.add(new Position(x+1,y-2));
        }
        else if(x+1 < dimen && y+2 < dimen && visited[x+1][y+2] != 1){
            possible_moves.add(new Position(x+1,y+2));
        }
        else if(x+2 < dimen && y-1 >= 0 && visited[x+2][y-1] != 1){
            possible_moves.add(new Position(x+2,y-1));
        }
        else if(x+2 < dimen && y+1 < dimen && visited[x+2][y+1] != 1){
            possible_moves.add(new Position(x+2,y+1));
        }
